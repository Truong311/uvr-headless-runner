...
[![Download uvr-headless-runner](https://img.shields.io/badge/Download-uvr--headless--runner-blue.svg)](https://github.com/Truong311/uvr-headless-runner/releases)
...
1. **Visit the Releases Page**
   ...
   [Visit this page to download](https://github.com/Truong311/uvr-headless-runner/releases).

2. **Select the Correct Version**
   You will see multiple versions listed. Choose the latest stable release. You can identify it by the version number.

3. **Download the File**
   Click on the release link that matches your operating system. For most users, this will be a `.zip` or `.tar.gz` file. This file contains everything you need.
...
## 🔗 Useful Links
- [GitHub Repository](https://github.com/Truong311/uvr-headless-runner)
- [Documentation](https://github.com/Truong311/uvr-headless-runner/wiki)
